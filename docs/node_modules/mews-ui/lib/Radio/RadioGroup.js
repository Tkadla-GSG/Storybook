    ...
    _createClass(RadioGroup, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                other = _objectWithoutProperties(_props, ['className', 'disabled', 'children']);
            ...
            return React.createElement(
                ...
                React.Children.map(children, function (child) {
                    return !isComponentOfType(child, RadioButton) ? child : React.cloneElement(child, _extends({}, other, {
